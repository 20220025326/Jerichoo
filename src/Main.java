...
public class Main {
    public static void main(String[] args) {
        // Create books
        Book book1 = new Book("Rich Dad Poor Dad", "Robert Kiyosaki", 1972);
        Book book2 = new Book("Kian is Dead", "Nikban", 2020);

        // Create DVDs
        DVD dvd1 = new DVD("Matrix", "qwerrty", 120);
        DVD dvd2 = new DVD("Michael Jordan: The Last Dance", "ABSCBN", 300);

        // Create students
        Student student1 = new Student("STUDENT Porras", "NB12");
        Student student2 = new Student("STUDENT Rubio", "BS13");

        // Create teachers
        Teacher teacher1 = new Teacher("TEACHER Rainiel", "AB24");
